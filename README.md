...
#CPU方式
python main_mil.py train --data="FilterNYT"  --batch_size=128 --gpu_ids -1
python main_mil.py train --data="NYT"  --batch_size=128 --gpu_ids -1
python main_att.py train --data="FilterNYT"  --batch_size=128 --gpu_ids -1
